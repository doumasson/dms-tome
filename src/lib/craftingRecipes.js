...
export const RECIPES = [
  {
    ...
    result: { name: 'Potion of Healing', type: 'consumable', rarity: 'common', healing: '2d4+2', price: 50 },
  ...
  },
  {
    ...
    result: { name: 'Potion of Greater Healing', type: 'consumable', rarity: 'uncommon', healing: '4d4+4', price: 150 },
    craftTime: 'Long rest',
    dc: 15,
    skill: 'Medicine',
  },
