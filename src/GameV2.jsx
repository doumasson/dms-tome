...
const LevelUpPanel        = lazy(() => import('./components/game/LevelUpPanel'))
const ExplorationActions  = lazy(() => import('./components/game/ExplorationActions'))
...
const EnemyInfo           = lazy(() => import('./components/game/EnemyInfo'))
