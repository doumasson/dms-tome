...
/**
 * XpNotification — shows a brief gold toast when the player gains XP.
 * Watches myCharacter.xp for changes and displays the delta.
 */
export default function XpNotification() {
  ...
  useEffect(() => {
    ...
    if (xp <= prev || prev === 0) return // skip initial load and decreases
    ...
    setNotification({ gained, progress, phase: 'in' })
