  ...
  return (
    <div style={styles.overlay} onClick={e => e.target === e.currentTarget && onClose()}>
      <div style={styles.modal}>
        ...
        <p style={styles.hint}>
          DM's Claude key is shared with the campaign so all players can use the Dungeon Master. Keys are never stored on any server outside the respective provider and your Supabase campaign record.
        </p>

        {/* Claude Key */}
        <label style={styles.label}>Claude API Key <span style={styles.labelHint}>(Dungeon Master • console.anthropic.com)</span></label>
        <input
          type="password"
          value={claudeKey}
